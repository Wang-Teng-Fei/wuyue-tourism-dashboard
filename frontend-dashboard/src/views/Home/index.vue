...
<template>
      ...
      <main id="content">
        ...
        <div class="c-left">
          ...
          <div class="c-left-bottom">
            <IncomeData :visualizationData="visualizationData"></IncomeData>
          </div>
        </div>
        ...
        <div class="c-center">
          ...
          <!-- 中下 -->
          <TotalCount :visualizationData="visualizationData"></TotalCount>
        </div>
  ...
  <div class="loading" v-if="!visualizationData.id">
    ...
    <div class="prompt">正在加载可视化界面······</div>
  </div>
</template>
...
.loading {
  ...
  .loader {
    ...
    --duration: 3s;
    --primary: rgb(217, 226, 255);
    --primary-light: #bbd1ffe1;

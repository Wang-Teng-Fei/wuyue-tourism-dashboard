...
// 获取：所有山脉高度统计列表（分页）
export const getMountainHeightAllList = (pageNum = page.value, pageSize = perPage.value) => {
...
// 新增：高度的年度统计数据
export const addMountainHeight = (data) => {
  return request.post(`/api/mountain-height/add`, data)
}

// 更新：高度的年度统计数据
export const updateMountainHeight = (height_id, data) => {
  return request.patch(`/api/mountain-height/${height_id}/update`, data)
}

// 删除：山脉高度的年度统计数据
export const deleteMountainHeight = (height_id) => {
